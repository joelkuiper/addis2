...
import org.drugis.addis2.dao.GenericDao;
...
public class ProjectsController {
	...
	private GenericDao<Population, Long> d_populationDao = new GenericDao<>(Population.class);
	...
	public String createAction(WebRequest request) {
		...
		d_populationDao.save(project.population);
